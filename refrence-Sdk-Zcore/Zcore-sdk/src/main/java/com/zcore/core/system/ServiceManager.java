...
public class ServiceManager {
    ...
    public static void initBlackManager() {
        ZCoreCore.get().getService(ACTIVITY_MANAGER);
        ZCoreCore.get().getService(JOB_MANAGER);
        ZCoreCore.get().getService(PACKAGE_MANAGER);
        ZCoreCore.get().getService(STORAGE_MANAGER);
        ZCoreCore.get().getService(USER_MANAGER);
        ZCoreCore.get().getService(XPOSED_MANAGER);
        ZCoreCore.get().getService(ACCOUNT_MANAGER);
        ZCoreCore.get().getService(LOCATION_MANAGER);
        ZCoreCore.get().getService(NOTIFICATION_MANAGER);
    }
}
