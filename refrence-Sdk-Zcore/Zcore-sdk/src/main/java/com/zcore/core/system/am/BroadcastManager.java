            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ZCoreCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_EXPORTED);
                    }else{
                        ZCoreCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            ZCoreCore.getContext().unregisterReceiver(broadcastReceiver);
