package com.zcore.core.system.location;
...
import com.zcore.entity.location.BCell;
import com.zcore.entity.location.BLocation;
import com.zcore.entity.location.BLocationConfig;
import com.zcore.fake.frameworks.BLocationManager;
import com.zcore.utils.CloseUtils;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                ZCoreCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
