...
import com.zcore.utils.TrieTree;
import java.io.File;
...
public class IOCore {
    ...
    public String redirectPath(String path) {
        ...
        if (!TextUtils.isEmpty(key)) {
            ...
            Log.d(TAG, "Redirecting path: " + key + " -> " + mRedirectMap.get(key));
        }
        return path;
    }
    ...
    public void enableRedirect(Context context) {
        ...
        try {
            ...
            int systemUserId = ZCoreCore.getHostUserId();
            ...
            if (ZCoreCore.getContext().getExternalCacheDir() != null
