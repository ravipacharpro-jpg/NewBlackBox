...
public class DaemonService extends Service {
    ...
    private static final int NOTIFY_ID = ZCoreCore.getHostPkg().hashCode();
    ...
    private void showNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getPackageName() + ".ZcoreRiyaz_core")
