package com.zcore.core.system.am;
...
import com.zcore.core.system.pm.PackageManagerCompat;
import com.zcore.proxy.ProxyActivity;
...
public class ActivityStack {
    ...
    public ActivityStack() {
        mAms = (ActivityManager) ZCoreCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    private int startActivityInNewTaskLocked(int userId, Intent intent, ActivityInfo
        ...
        ZCoreCore.getContext().startActivity(shadow);
        return 0;
    }
    ...
    private int realStartActivityLocked(IInterface appThread, Intent intent, String resolvedType,
        ...
        try {
            ...
            BRIActivityManager.get(BRActivityManagerNative.get().getDefault()).startActivity(appThread, ZCoreCore.getHostPkg(), intent,
    ...
    private Intent getStartStubActivityIntentInner(Intent intent, int vpid,
        ...
        try {
            Resources resources = PackageManagerCompat.getResources(ZCoreCore.getContext(), activityInfo.applicationInfo);
            int id;
            ...
            if (windowIsTranslucent) {
                shadow.setComponent(new ComponentName(ZCoreCore.getHostPkg(), ProxyManifest.TransparentProxyActivity(vpid)));
            } else {
                shadow.setComponent(new ComponentName(ZCoreCore.getHostPkg(), ProxyManifest.getProxyActivity(vpid)));
            }
    ...
    public ComponentName getCallingActivity(IBinder token, int userId) {
        synchronized (mTasks) {
            ...
            return new ComponentName(ZCoreCore.getHostPkg(), ProxyActivity.P0.class.getName());
        }
    }
