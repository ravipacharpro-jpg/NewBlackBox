package com.zcore.core.system.os;
...
import com.zcore.fake.provider.FileProvider;
...
public class BStorageManagerService extends IBStorageManagerService.Stub implements ISystemService {
    ...
    public Uri getUriForFile(String file) throws RemoteException {
        return FileProvider.getUriForFile(ZCoreCore.getContext(), ProxyManifest.getProxyFileProvider(), new File(file));
    }
