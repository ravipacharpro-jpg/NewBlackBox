...
import com.zcore.core.system.pm.IBPackageManagerService;
...
public class BPackageManager extends BlackManager<IBPackageManagerService> {
    ...
    public Intent getLaunchIntentForPackage(String packageName, int userId) {
        ...
        List<ResolveInfo> queryIntentActivities = queryIntentActivities(intentToResolve,0,intentToResolve.resolveTypeIfNeeded(ZCoreCore.getContext().getContentResolver()),userId);
        ...
        if (queryIntentActivities == null || queryIntentActivities.size() <= 0) {
            ...
            intentToResolve.setPackage(packageName);
            queryIntentActivities = queryIntentActivities(intentToResolve,0,intentToResolve.resolveTypeIfNeeded(ZCoreCore.getContext().getContentResolver()),userId);
        }
        if (queryIntentActivities == null || queryIntentActivities.size() <= 0) {
            return null;
        }
