...
import com.zcore.fake.provider.FileProviderHandler;
import com.zcore.utils.ComponentUtils;
import com.zcore.utils.MethodParameterUtils;
import com.zcore.utils.Slog;
import com.zcore.utils.compat.BuildCompat;
import com.zcore.utils.compat.StartActivityCompat;
...
public class ActivityManagerCommonProxy {
    ...
    public static class StartActivity extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (ComponentUtils.isRequestInstall(intent)) {
                ...
                if (ZCoreCore.get().requestInstallPackage(file, BActivityThread.getUserId())) {
                    return 0;
                }
            ...
            if (dataString != null && dataString.equals("package:" + BActivityThread.getAppPackageName())) {
                intent.setData(Uri.parse("package:" + ZCoreCore.getHostPkg()));
            }

            ResolveInfo resolveInfo = ZCoreCore.getBPackageManager().resolveActivity(intent,GET_META_DATA,StartActivityCompat.getResolvedType(args),BActivityThread.getUserId());
            if (resolveInfo == null) {
                ...
                resolveInfo = ZCoreCore.getBPackageManager().resolveActivity(intent,GET_META_DATA,StartActivityCompat.getResolvedType(args),BActivityThread.getUserId());
                if (resolveInfo == null) {
            ...
            ZCoreCore.getBActivityManager().startActivityAms(BActivityThread.getUserId(),
    ...
    public static class StartActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ZCoreCore.getBActivityManager().startActivities(BActivityThread.getUserId(),
    ...
    public static class ActivityResumed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ZCoreCore.getBActivityManager().onActivityResumed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class ActivityDestroyed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ZCoreCore.getBActivityManager().onActivityDestroyed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class FinishActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ZCoreCore.getBActivityManager().onFinishActivity((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class getCallingPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return ZCoreCore.getBActivityManager().getCallingPackage((IBinder) args[0], BActivityThread.getUserId());
        }
    }
    ...
    public static class getCallingActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return ZCoreCore.getBActivityManager().getCallingActivity((IBinder) args[0], BActivityThread.getUserId());
        }
    }
}
