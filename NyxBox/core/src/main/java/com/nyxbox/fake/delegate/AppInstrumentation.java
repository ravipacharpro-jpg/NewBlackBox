...
import com.nyxbox.utils.HackAppUtils;
import com.nyxbox.utils.compat.ActivityCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            BRActivityThread.get(NyxBoxCore.mainThread())._set_mInstrumentation(this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
