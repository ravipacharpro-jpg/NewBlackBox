    ...
    public static class AttributionSourceConstructor extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                int uid = NyxBoxCore.getHostUid();
                String packageName = NyxBoxCore.getHostPkg();
                ...
                return createSafeAttributionSource(NyxBoxCore.getHostUid(), NyxBoxCore.getHostPkg());
            }
        }
    ...
    public static class FromParcel extends MethodHook {
        ...
        private void fixAttributionSourceUid(Object attributionSource) {
            try {
                ...
                setUidMethod.invoke(attributionSource, NyxBoxCore.getHostUid());
                
                Slog.d(TAG, "Fixed AttributionSource UID to: " + NyxBoxCore.getHostUid());
            } catch (Exception e) {
