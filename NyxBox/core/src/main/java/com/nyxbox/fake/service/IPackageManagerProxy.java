...
import com.nyxbox.android.app.ContextImpl;
import com.nyxbox.android.content.pm.BRPackageManager;
import com.nyxbox.NyxBoxCore;
import com.nyxbox.app.BActivityThread;
import com.nyxbox.core.env.AppSystemEnv;
import com.nyxbox.fake.FakeCore;
...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        ...
        Object systemContext = BRActivityThread.get(NyxBoxCore.mainThread()).getSystemContext();
    ...
    public static class ResolveIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = NyxBoxCore.getBPackageManager().resolveIntent(intent, resolvedType, flags, NyxBoxCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
    ...
    public static class ResolveService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            String resolvedType = (String) args[1];
            int flags = MethodParameterUtils.toInt(args[2]);
            ResolveInfo resolveInfo = NyxBoxCore.getBPackageManager().resolveService(intent, flags, resolvedType, NyxBoxCore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
            return method.invoke(who, args);
    ...
    public static class GetPackageInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            PackageInfo packageInfo = NyxBoxCore.getBPackageManager().getPackageInfo(packageName, flags, NyxBoxCore.getUserId());
            if (packageInfo != null) {
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = NyxBoxCore.getBPackageManager().getProviderInfo(componentName, flags, NyxBoxCore.getUserId());
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo receiverInfo = NyxBoxCore.getBPackageManager().getReceiverInfo(componentName, flags, NyxBoxCore.getUserId());
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo activityInfo = NyxBoxCore.getBPackageManager().getActivityInfo(componentName, flags, NyxBoxCore.getUserId());
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ServiceInfo serviceInfo = NyxBoxCore.getBPackageManager().getServiceInfo(componentName, flags, NyxBoxCore.getUserId());
            if (serviceInfo != null)
                return serviceInfo;
            if (AppSystemEnv.isOpenPackage(componentName)) {
                return method.invoke(who, args);
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ApplicationInfo> installedApplications = NyxBoxCore.getBPackageManager().getInstalledApplications(flags, NyxBoxCore.getUserId());
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[0]);
            List<PackageInfo> installedPackages = NyxBoxCore.getBPackageManager().getInstalledPackages(flags, NyxBoxCore.getUserId());
    ...
    public static class GetApplicationInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = NyxBoxCore.getBPackageManager().getApplicationInfo(packageName, flags, NyxBoxCore.getUserId());
    ...
    public static class QueryContentProviders extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[2]);
            List<ProviderInfo> providers = NyxBoxCore.getBPackageManager().
                    queryContentProviders(NyxBoxCore.getAppProcessName(), NyxBoxCore.getBUid(), flags, NyxBoxCore.getUserId());
    ...
    public static class QueryBroadcastReceivers extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ResolveInfo> resolves = NyxBoxCore.getBPackageManager().queryBroadcastReceivers(intent, flags, type, BActivityThread.getUserId());
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = NyxBoxCore.getBPackageManager().resolveContentProvider(authority, flags, BActivityThread.getUserId());
            if (providerInfo == null) {
                return method.invoke(who, args);
            }
            return providerInfo;
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == NyxBoxCore.getHostUid()) {
                args[0] = BActivityThread.getBUid();
                uid = (int) args[0];
            }
            String[] packagesForUid = NyxBoxCore.getBPackageManager().getPackagesForUid(uid);
    ...
    public static class getComponentEnabledSetting extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = NyxBoxCore.getBPackageManager().getApplicationInfo(packageName,0, BActivityThread.getUserId());
