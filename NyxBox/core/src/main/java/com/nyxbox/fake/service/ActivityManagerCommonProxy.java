...
import com.nyxbox.fake.provider.FileProviderHandler;
...
import com.nyxbox.utils.compat.StartActivityCompat;
...
public class ActivityManagerCommonProxy {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (ComponentUtils.isRequestInstall(intent)) {
                ...
                if (file != null && file.exists()) {
                    try {
                        PackageInfo packageInfo = NyxBoxCore.getPackageManager().getPackageArchiveInfo(file.getAbsolutePath(), 0);
                        if (packageInfo != null) {
                ...
                if (NyxBoxCore.get().requestInstallPackage(file, BActivityThread.getUserId())) {
                    return 0;
                }
            ...
            if (dataString != null && dataString.equals("package:" + BActivityThread.getAppPackageName())) {
                intent.setData(Uri.parse("package:" + NyxBoxCore.getHostPkg()));
            }

            ResolveInfo resolveInfo = NyxBoxCore.getBPackageManager().resolveActivity(
                    intent,
                    GET_META_DATA,
            ...
            if (resolveInfo == null) {
                ...
                resolveInfo = NyxBoxCore.getBPackageManager().resolveActivity(
                        intent,
                        GET_META_DATA,
                        StartActivityCompat.getResolvedType(args),
                        BActivityThread.getUserId());
            ...
            NyxBoxCore.getBActivityManager().startActivityAms(BActivityThread.getUserId(),
    ...
    public static class StartActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return NyxBoxCore.getBActivityManager().startActivities(BActivityThread.getUserId(),
    ...
    public static class ActivityResumed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            NyxBoxCore.getBActivityManager().onActivityResumed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class ActivityDestroyed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            NyxBoxCore.getBActivityManager().onActivityDestroyed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class FinishActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            NyxBoxCore.getBActivityManager().onFinishActivity((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class getCallingPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return NyxBoxCore.getBActivityManager().getCallingPackage((IBinder) args[0], BActivityThread.getUserId());
        }
    }
    ...
    public static class getCallingActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return NyxBoxCore.getBActivityManager().getCallingActivity((IBinder) args[0], BActivityThread.getUserId());
        }
    }
}
