            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                public void uncaughtException(Thread thread, Throwable throwable) {
                    ...
                    if (isNullContextCrash(throwable)) {
                        ...
                        NyxBoxCore.get().sendLogs("CRASH DETECTED (Caught/NullContext): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isGooglePlayServicesCrash(throwable)) {
                        ...
                        NyxBoxCore.get().sendLogs("CRASH DETECTED (Caught/GMS): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isWebViewCrash(throwable)) {
                        ...
                        NyxBoxCore.get().sendLogs("CRASH DETECTED (Caught/WebView): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isAttributionSourceCrash(throwable)) {
                        ...
                        NyxBoxCore.get().sendLogs("CRASH DETECTED (Caught/Attribution): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isSocialMediaAppCrash(throwable)) {
                        ...
                        NyxBoxCore.get().sendLogs("CRASH DETECTED (Caught/SocialMedia): " + throwable.getMessage(), true);
                        return; 
                    }
