        ...
        try {
            ...
            for (String fieldName : uidFieldNames) {
                try {
                    ...
                    uidField.set(attributionSource, NyxBoxCore.getHostUid());
            ...
            for (String fieldName : packageFieldNames) {
                try {
                    ...
                    packageField.set(attributionSource, NyxBoxCore.getHostPkg());
    ...
    public static Object createSafeAttributionSource() {
        try {
            ...
            try {
                ...
                attributionSource = constructor.newInstance(NyxBoxCore.getHostUid(), NyxBoxCore.getHostPkg());
            } catch (Exception e) {
                try {
