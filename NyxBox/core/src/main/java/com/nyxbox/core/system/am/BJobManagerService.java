...
import com.nyxbox.android.app.job.BRJobInfo;
...
import com.nyxbox.entity.JobRecord;
...
public class BJobManagerService extends IBJobManagerService.Stub implements ISystemService {
    ...
    public JobInfo scheduleJob(ProcessRecord processRecord, JobInfo info, ServiceInfo serviceInfo) {
        ...
        BRJobInfo.get(info)._set_service(new ComponentName(NyxBoxCore.getHostPkg(), ProxyManifest.getProxyJobService(processRecord.bpid)));
        return info;
    }
