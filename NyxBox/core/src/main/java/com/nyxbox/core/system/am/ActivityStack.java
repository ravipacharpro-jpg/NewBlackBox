package com.nyxbox.core.system.am;
...
import com.nyxbox.core.system.pm.PackageManagerCompat;
import com.nyxbox.proxy.ProxyActivity;
import com.nyxbox.proxy.ProxyManifest;
import com.nyxbox.proxy.record.ProxyActivityRecord;
import com.nyxbox.utils.ComponentUtils;
...
public class ActivityStack {
    ...
    public ActivityStack() {
        mAms = (ActivityManager) NyxBoxCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    private int startActivityInNewTaskLocked(int userId, Intent intent, ActivityInfo
        ...
        NyxBoxCore.getContext().startActivity(shadow);
        return 0;
    }
    ...
    private int realStartActivityLocked(IInterface appThread, Intent intent, String resolvedType,
        ...
        try {
            ...
            BRIActivityManager.get(BRActivityManagerNative.get().getDefault()).startActivity(appThread, NyxBoxCore.getHostPkg(), intent,
    ...
    private Intent getStartStubActivityIntentInner(Intent intent, int vpid,
        ...
        try {
            Resources resources = PackageManagerCompat.getResources(NyxBoxCore.getContext(), activityInfo.applicationInfo);
            int id;
            ...
            if (windowIsTranslucent) {
                shadow.setComponent(new ComponentName(NyxBoxCore.getHostPkg(), ProxyManifest.TransparentProxyActivity(vpid)));
            } else {
                shadow.setComponent(new ComponentName(NyxBoxCore.getHostPkg(), ProxyManifest.getProxyActivity(vpid)));
            }
    ...
    public ComponentName getCallingActivity(IBinder token, int userId) {
        synchronized (mTasks) {
            ...
            return new ComponentName(NyxBoxCore.getHostPkg(), ProxyActivity.P0.class.getName());
        }
    }
