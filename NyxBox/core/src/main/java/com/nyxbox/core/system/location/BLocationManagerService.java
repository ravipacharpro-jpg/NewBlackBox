package com.nyxbox.core.system.location;
...
import com.nyxbox.android.location.BRILocationListener;
import com.nyxbox.android.location.BRILocationListenerStub;
import com.nyxbox.NyxBoxCore;
import com.nyxbox.core.env.BEnvironment;
import com.nyxbox.core.system.ISystemService;
import com.nyxbox.entity.location.BCell;
import com.nyxbox.entity.location.BLocation;
import com.nyxbox.entity.location.BLocationConfig;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                NyxBoxCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
