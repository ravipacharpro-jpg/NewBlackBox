...
Java_com_nyxbox_security_SdkProtectionManager_mediateLibraryLoadingNative(JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_nyxbox_security_SdkProtectionManager_ensureSignalCompatibilityNative(JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_nyxbox_security_SdkProtectionManager_virtualizePathsNative(JNIEnv* env, jobject thiz) {
