...
object nk {
    ...
    fun getActivatedSdk(): Boolean {
        ...
        val context = NyxBoxCore.getContext() ?: return false
    ...
    fun setHidden(status: String?) {
        ...
        hiddenFlag = value
        NyxBoxCore.getContext()?.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE)
    ...
    fun checkExpiryManually(): String {
        val context = NyxBoxCore.getContext() ?: return "No context"
        val sp = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE)
    ...
    fun loadSavedStatus() {
        try {
            val context = NyxBoxCore.getContext() ?: return
            val sp = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE)
