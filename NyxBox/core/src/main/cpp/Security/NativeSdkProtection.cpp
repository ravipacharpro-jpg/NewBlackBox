...
Java_com_nyxbox_security_SdkProtectionManager_mediateLibraryLoadingNative(JNIEnv*, jobject) {
    LOGD("mediateLibraryLoadingNative enabled");
}

extern "C" JNIEXPORT void JNICALL
Java_com_nyxbox_security_SdkProtectionManager_ensureSignalCompatibilityNative(JNIEnv*, jobject) {
...
Java_com_nyxbox_security_SdkProtectionManager_setCrashRecoveryPoint(JNIEnv*, jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_nyxbox_security_SdkProtectionManager_virtualizePathsNative(JNIEnv*, jobject) {
