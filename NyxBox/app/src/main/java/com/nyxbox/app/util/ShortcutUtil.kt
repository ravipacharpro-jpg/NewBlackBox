...
import com.nyxbox.app.util.ContextUtil.openAppSystemSettings
import com.nyxbox.app.view.main.ShortcutActivity
...
object ShortcutUtil {
    ...
    private fun showAllowPermissionDialog(context: Context){
        if (!AppManager.mNyxBoxLoader.showShortcutPermissionDialog()){
            return
        }
        ...
        MaterialDialog(context).show {
            ...
            neutralButton(R.string.no_reminders){
                AppManager.mNyxBoxLoader.invalidShortcutPermissionDialog(false)
            }
        }
