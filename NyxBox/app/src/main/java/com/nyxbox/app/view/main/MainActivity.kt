...
import com.nyxbox.app.databinding.ActivityMainBinding
import com.nyxbox.app.util.Resolution
import com.nyxbox.app.util.inflate
import com.nyxbox.app.view.apps.AppsFragment
import com.nyxbox.app.view.base.LoadingActivity
import com.nyxbox.app.view.fake.FakeManagerActivity
import com.nyxbox.app.view.list.ListActivity
import com.nyxbox.app.view.setting.SettingActivity
...
class MainActivity : LoadingActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            try {
                NyxBoxCore.get().onBeforeMainActivityOnCreate(this)
            } catch (e: Exception) {
            ...
            try {
                NyxBoxCore.get().onAfterMainActivityOnCreate(this)
            } catch (e: Exception) {
    ...
    private fun initViewPager() {
        try {
            val userList = NyxBoxCore.get().users
