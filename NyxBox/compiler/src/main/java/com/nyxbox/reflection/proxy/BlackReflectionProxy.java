...
import com.nyxbox.reflection.BlackReflectionInfo;
import com.nyxbox.reflection.utils.ClassUtils;


public class BlackReflectionProxy {

    private static final ClassName BR = ClassName.get("com.nyxbox.reflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.nyxbox.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
