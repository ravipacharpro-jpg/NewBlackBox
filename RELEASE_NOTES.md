...
**Files Changed:**
- `app/src/main/java/com/nyxbox/app/view/main/NyxBoxLoader.kt`
- `app/src/main/java/com/nyxbox/app/view/setting/SettingFragment.kt`
- `app/src/main/res/xml/setting.xml`
- `app/src/main/res/values/strings.xml`
- `Bcore/src/main/java/com/nyxbox/app/configuration/ClientConfiguration.java`
- `Bcore/src/main/java/com/nyxbox/NyxBoxCore.java`
...
**Files Changed:**
- `app/src/main/java/com/nyxbox/app/view/main/MainActivity.kt`
...
**Files Changed:**
- `Bcore/src/main/java/com/nyxbox/fake/service/context/providers/SystemProviderStub.java`
- `Bcore/src/main/java/com/nyxbox/fake/hook/ClassInvocationStub.java`
...
```
OppoThermalStats: PackageManager$NameNotFoundException: com.nyxbox.app:p0
```
