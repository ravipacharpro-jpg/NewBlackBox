...
import com.nyxbox.android.content.pm.BRApplicationInfoL;
import com.nyxbox.android.content.pm.BRApplicationInfoN;
import com.nyxbox.android.content.pm.BRPackageParserSigningDetails;
import com.nyxbox.android.content.pm.BRSigningInfo;
import com.nyxbox.android.content.res.BRAssetManager;
...
import com.nyxbox.utils.ArrayUtils;
...
public class PackageManagerCompat {
    ...
    public static PackageInfo generatePackageInfo(BPackage p, int flags, long firstInstallTime, long lastUpdateTime, BPackageUserState state, int userId) {
        ...
        try {
            base = NyxBoxCore.getContext().getPackageManager().getPackageInfo(p.packageName, flags);
    ...
    public static ApplicationInfo generateApplicationInfo(BPackage p, int flags, BPackageUserState state, int userId) {
        ...
        try {
            baseApplication = NyxBoxCore.getPackageManager().getApplicationInfo(NyxBoxCore.getHostPkg(), flags);
        } catch (Exception e) {
            return null;
        }
        String sourceDir = p.baseCodePath;
        if (p.applicationInfo == null) {
            p.applicationInfo = NyxBoxCore.getPackageManager()
