            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        NyxBoxCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_EXPORTED);
                    }else{
                        NyxBoxCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            NyxBoxCore.getContext().unregisterReceiver(broadcastReceiver);
