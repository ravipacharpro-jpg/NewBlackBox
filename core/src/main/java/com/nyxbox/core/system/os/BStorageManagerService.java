package com.nyxbox.core.system.os;
...
import com.nyxbox.android.os.storage.BRStorageManager;
import com.nyxbox.android.os.storage.BRStorageVolume;
...
import com.nyxbox.fake.provider.FileProvider;
...
public class BStorageManagerService extends IBStorageManagerService.Stub implements ISystemService {
    ...
    public Uri getUriForFile(String file) throws RemoteException {
        return FileProvider.getUriForFile(NyxBoxCore.getContext(), ProxyManifest.getProxyFileProvider(), new File(file));
    }
