...
public class BEnvironment {
    private static final File sVirtualRoot = new File(NyxBoxCore.getContext().getCacheDir().getParent(), "blackbox");
    private static final File sExternalVirtualRoot;

    static {
        sExternalVirtualRoot = new File(Environment.getExternalStorageDirectory(), "NyxBox");
    }
    ...
    public static File getXSharedPreferences(String packageName, String prefFileName) {
       return new File(BEnvironment.getDataDir(packageName, NyxBoxCore.getUserId()), "shared_prefs/" + prefFileName + ".xml");
    }
