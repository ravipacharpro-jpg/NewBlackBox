...
import com.nyxbox.android.app.BRActivityManagerOreo;
import com.nyxbox.android.app.BRLoadedApkReceiverDispatcher;
import com.nyxbox.android.app.BRLoadedApkReceiverDispatcherInnerReceiver;
import com.nyxbox.android.app.BRLoadedApkServiceDispatcher;
import com.nyxbox.android.app.BRLoadedApkServiceDispatcherInnerConnection;
import com.nyxbox.android.content.BRContentProviderNative;
...
import com.nyxbox.entity.am.RunningAppProcessInfo;
import com.nyxbox.entity.am.RunningServiceInfo;
import com.nyxbox.fake.delegate.ContentProviderDelegate;
import com.nyxbox.fake.delegate.InnerReceiverDelegate;
import com.nyxbox.fake.delegate.ServiceConnectionDelegate;
...
import com.nyxbox.proxy.record.ProxyPendingRecord;
...
import com.nyxbox.utils.compat.ParceledListSliceCompat;
...
public class IActivityManagerProxy extends ClassInvocationStub {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (auth instanceof String) {
                ...
                if (auth.equals("settings")
                    ...
                    ProviderInfo providerInfo = NyxBoxCore.getBPackageManager()
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = NyxBoxCore.getBPackageManager().resolveService(intent, 0, resolvedType, BActivityThread.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            ...
            return NyxBoxCore.getBActivityManager().startService(intent, resolvedType, requireForeground, BActivityThread.getUserId());
        }
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                return NyxBoxCore.getBActivityManager().stopService(intent, resolvedType, BActivityThread.getUserId());
            } catch (SecurityException e) {
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                NyxBoxCore.getBActivityManager().stopServiceToken(componentName, token, BActivityThread.getUserId());
                return true;
            } catch (SecurityException e) {
    ...
    public static Object BindServiceCommon(Object who, Method method, Object[] args,int callingPackageIndex) throws Throwable {
        try {
            ...
            ResolveInfo resolveInfo = NyxBoxCore.getBPackageManager().resolveService(intent, 0, resolvedType, userId);
            if (resolveInfo != null || AppSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = NyxBoxCore.getBActivityManager().bindService(intent,
                ...
                if (proxyIntent != null && proxyIntent.getComponent() != null && 
                    proxyIntent.getComponent().getPackageName().equals(NyxBoxCore.getHostPkg())){
                ...
                args[callingPackageIndex] = NyxBoxCore.getHostPkg();
    ...
    public static class BindService extends MethodHook {
        ...
        protected boolean isEnable() {
            return NyxBoxCore.get().isBlackProcess() || NyxBoxCore.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            NyxBoxCore.getBActivityManager().unbindService(iServiceConnection.asBinder(), BActivityThread.getUserId());
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                switch (type) {
                    case ActivityManagerCompat.INTENT_SENDER_ACTIVITY:
                        ...
                        shadow.setComponent(new ComponentName(NyxBoxCore.getHostPkg(), ProxyManifest.getProxyPendingActivity(BActivityThread.getAppPid())));
            ...
            if (invoke != null) {
                ...
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{NyxBoxCore.getHostPkg()};
                }
                NyxBoxCore.getBActivityManager().getIntentSender(invoke.asBinder(), packagesForUid[0], BActivityThread.getCallingBUid());
            }
            return invoke;
        }
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return NyxBoxCore.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return NyxBoxCore.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = NyxBoxCore.getBActivityManager().sendBroadcast(intent, resolvedType, BActivityThread.getUserId());
            if (proxyIntent != null) {
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            IBinder peek = NyxBoxCore.getBActivityManager().peekService(intent, resolvedType, BActivityThread.getUserId());
            return peek;
        }
    }
