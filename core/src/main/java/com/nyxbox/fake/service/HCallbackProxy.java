...
import com.nyxbox.android.app.ActivityThreadActivityClientRecordContext;
import com.nyxbox.android.app.BRActivityClient;
import com.nyxbox.android.app.BRActivityClientActivityClientControllerSingleton;
...
import com.nyxbox.android.app.BRActivityThreadCreateServiceData;
import com.nyxbox.android.app.BRActivityThreadH;
import com.nyxbox.android.app.BRIActivityManager;
import com.nyxbox.android.app.servertransaction.BRClientTransaction;
import com.nyxbox.android.app.servertransaction.BRLaunchActivityItem;
import com.nyxbox.android.app.servertransaction.LaunchActivityItem;
import com.nyxbox.android.app.servertransaction.LaunchActivityItemContext;
import com.nyxbox.android.os.BRHandler;
import com.nyxbox.NyxBoxCore;
import com.nyxbox.app.BActivityThread;
import com.nyxbox.fake.hook.IInjectHook;
import com.nyxbox.proxy.ProxyManifest;
import com.nyxbox.proxy.record.ProxyActivityRecord;
...
public class HCallbackProxy implements IInjectHook, Handler.Callback {
    ...
    private Handler getH() {
        Object currentActivityThread = NyxBoxCore.mainThread();
    ...
    try {
        ...
        if (BActivityThread.getAppConfig() == null) {
            try {
                NyxBoxCore.getBActivityManager().restartProcess(
                    activityInfo.packageName, 
                    activityInfo.processName, 
                    stubRecord.mUserId
                );

                Intent launchIntentForPackage = NyxBoxCore.getBPackageManager()
        ...
        try {
            ...
            NyxBoxCore.getBActivityManager()
            ...
            if (Build.VERSION.SDK_INT == 31 || 
                ...
                Object record = BRActivityThread.get(NyxBoxCore.mainThread())
    ...
    private boolean handleCreateService(Object data) {
        if (BActivityThread.getAppConfig() != null) {
            ...
            if (!serviceInfo.name.equals(ProxyManifest.getProxyService(BActivityThread.getAppPid()))
                ...
                NyxBoxCore.getBActivityManager().startService(intent, null, false, BActivityThread.getUserId());
                return true;
            }
        }
        return false;
