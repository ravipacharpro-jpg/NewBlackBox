...
import com.nyxbox.app.databinding.FragmentAppsBinding
import com.nyxbox.app.util.InjectionUtil
import com.nyxbox.app.util.ShortcutUtil
...
import com.nyxbox.app.view.main.MainActivity
import java.util.*
...
class AppsFragment : Fragment() {
    ...
    override fun onStart() {
        try {
            ...
            try {
                NyxBoxCore.get().addServiceAvailableCallback {
    ...
    private fun stopApk(info: AppInfo) {
        try {
            MaterialDialog(requireContext()).show {
                ...
                positiveButton(R.string.done) {
                    try {
                        NyxBoxCore.get().stopPackage(info.packageName, userID)
