...
import com.nyxbox.app.app.rocker.RockerManager
import com.nyxbox.app.biz.cache.AppSharedPreferenceDelegate
...
class NyxBoxLoader {
                                    ...
                                    try {
                                        ...
                                        val intent =
                                                android.content.Intent(
                                                        "com.nyxbox.app.REQUEST_STORAGE_PERMISSION"
                                                )
    ...
    companion object {
        val TAG: String = NyxBoxLoader::class.java.simpleName
    }
}
